...
class caiji{
    ...
    {
        return mysql_query("INSERT INTO `cits_collect_copy`(`".implode('`,`', array_keys($array))."`) VALUES('".implode("','", $array)."')");
    }
...
//獲取某個範圍url
    function get_url_all($url,$catid,$areaid){
        ...
        preg_match_all("/<div class=\"pre_detail_set\"(.*)wp-pagenavi/isU", $con, $rs);
